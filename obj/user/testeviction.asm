...
obj/user/testeviction.debug:     file format elf64-x86-64
...
umain(int argc, char **argv)
{
  ...
  800985:	ff d0                	callq  *%rax
	for (i = 0; i < (NDIRECT*4)*BLKSIZE; i += sizeof(buf)) {
  ...
  800a16:	48 81 7d e8 ff 7f 02 	cmpq   $0x27fff,-0x18(%rbp)
  800a1d:	00 
  ...
  800bb7:	48 81 7d e8 ff 7f 02 	cmpq   $0x27fff,-0x18(%rbp)
  800bbe:	00 
